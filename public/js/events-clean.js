// Módulo de eventos - Versión limpia y funcional
console.log('🎯 Loading Events Clean Module...');
...
async function searchStudents(query, resultsDiv) {
    try {
        ...
        if (typeof query !== 'string') {
            console.error('❌ Query is not a string:', typeof query, query);
            return;
        }
        
        // Validar que resultsDiv exista
        if (!resultsDiv) {
        ...
        const demoStudents = [
            ...
            { id: 'demo-5', firstName: 'Luis', lastName: 'Hernández Castro', document: '9988776655', grade: { name: '11°' }, group: { name: 'A' } },
            { id: 'demo-6', firstName: 'Sofia', lastName: 'Jiménez Morales', document: '1357924680', grade: { name: '9°' }, group: { name: 'B' } },
            { id: 'demo-7', firstName: 'Diego', lastName: 'Vargas Ruiz', document: '2468135790', grade: { name: '10°' }, group: { name: 'B' } },
            { id: 'demo-8', firstName: 'Valentina', lastName: 'Torres Mendoza', document: '3691472580', grade: { name: '11°' }, group: { name: 'C' } },
            { id: 'demo-9', firstName: 'Andrea', lastName: 'Morales Vega', document: '4567891230', grade: { name: '9°' }, group: { name: 'C' } },
            { id: 'demo-10', firstName: 'Andrés Felipe', lastName: 'Castillo Ruiz', document: '7890123456', grade: { name: '10°' }, group: { name: 'A' } }
        ];
        
        const students = demoStudents.filter(student => 
        ...
        // Verificar que resultsDiv exista antes de modificarlo
        if (resultsDiv && resultsDiv.innerHTML !== undefined) {
            resultsDiv.innerHTML = `
...
console.log('✅ Events Clean Module loaded successfully');